...
<div class="container" style="width: 100%">
    <br>
    <form action="/cust_orders" method="get">
    <div class="row">
            @csrf
            <div class="col-md-4">
        ...
        <select name="cust_id" id="cust_id" required class="form-control select2" style="width: 100%;">
            <option value=''> إختر عميل ...</option>
            @foreach($cutomers as $cutomer)
                <option value="{{$cutomer->id}}">{{$cutomer->name}}</option>
            @endforeach
        </select>
    </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="">
                <form action="/generate_pdf_profile" method="get">
                        @csrf
                           ...
                           <input style="width: 50%" type="hidden" id="cust_pdf" name="cust_pdf"
                                   value="">
                ...
                <form id="form_order_id" action="/getorderonly_prof" method="get">
                        @csrf
